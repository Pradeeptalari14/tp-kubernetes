# 🔧 Troubleshooting Guide — Advanced k8s Script Generator
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-kubernetes/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/kubernetes/)
